...
@Repository
@Transactional
public interface ExploratoryDiscoveryRepository extends JpaRepository<ExploratoryDiscoveryDTO, String> {
    @Query(value = "select exploratory_discovery_id_seq.nextval from dual", nativeQuery = true)
